                    ...
                    <div class="widget-header">
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Client Completed Projects</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-control  basic" name="services_id">
                                            @foreach($services as $service)
                                                <option @if($service->id == $portfolio->services_id) selected
                                ...
                                <div class="col-6">
                                    <div>
                                        ...
                                        <select class="form-control tagging" multiple="multiple" name="tags[]">
                                            ...
                                            <option @if(Str::contains($portfolio->tags,'Laravel')) selected  @endif value="Laravel">Laravel</option>
                                            <option @if(Str::contains($portfolio->tags,'Bootstrap')) selected  @endif value="Bootstrap">Bootstrap</option>
                                            <option @if(Str::contains($portfolio->tags,'TailwindCss')) selected  @endif  value="TailwindCss">TailwindCss</option>
                                            <option @if(Str::contains($portfolio->tags,'JavaScript')) selected  @endif value="JavaScript">JavaScript</option>
                                        </select>
                                        <div class="text-danger">
                                            @error('tags')
                                            {{$message}}
