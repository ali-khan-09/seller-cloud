...
<link rel="stylesheet" type="text/css" href="{{asset('dashboard_assets/plugins/select2/select2.min.css')}}">
<link href="{{asset('dashboard_assets/plugins/file-upload/file-upload-with-preview.min.css')}}" rel="stylesheet" type="text/css" />

<link href="{{asset('dashboard_assets/plugins/animate/animate.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('dashboard_assets/plugins/sweetalerts/sweetalert2.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('dashboard_assets/plugins/sweetalerts/sweetalert.css')}}" rel="stylesheet" type="text/css" />
<link href="{{asset('dashboard_assets/assets/css/components/custom-sweetalert.css')}}" rel="stylesheet" type="text/css" />

{{--tables style sheets--}}
<link rel="stylesheet" type="text/css" href="{{asset('dashboard_assets/plugins/table/datatable/datatables.css')}}">
