    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="{{asset('dashboard_assets/assets/img/logo.svg')}}" class="navbar-logo" alt="logo">
                </a>
            </li>
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="{{asset('dashboard_assets/assets/img/profile-17.jpg')}}" class="img-fluid mr-2" alt="avatar">
...
{{--                            {{ __('Logout') }}--}}
{{--                        </a>--}}
                        <form id="dashboard-logout" action="{{route('dashboard.logout')}}" method="post">
                            @csrf
